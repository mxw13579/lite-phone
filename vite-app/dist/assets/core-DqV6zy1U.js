...
const DEFAULT_AVATAR = "https://i.postimg.cc/PxZrFFFL/o-o-1.jpg";
const DEFAULT_MY_GROUP_AVATAR = "https://i.postimg.cc/cLPP10Vm/4.jpg";
const DEFAULT_GROUP_MEMBER_AVATAR = "https://i.postimg.cc/VkQfgzGJ/1.jpg";
const DEFAULT_GROUP_AVATAR = "https://i.postimg.cc/gc3QYCDy/1-NINE7-Five.jpg";
...
async function updateGlobalSettings(newSettings) {
  ...
  const saveGlobalSettings = window.saveGlobalSettings;
...
function setPersonaPresets(presets) {
  state.personaPresets = presets;
  console.log("状态更新：角色预设已更新");
}
function removePersonaPreset(presetId) {
...
function isGroupChat(chatId = state.activeChatId) {
