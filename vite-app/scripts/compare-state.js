...
// 判断是否应该忽略某些差异
function shouldIgnoreDifference(path, value1, value2) {
  // 忽略时间戳类差异
...
// 生成比较报告
function generateComparisonReport(snapshot1, snapshot2, label1 = 'Version 1', label2 = 'Version 2') {
...
const VALIDATION_MATRIX = [
  ...
  { name: '全局API兼容', check: () => {
    ...
    return requiredAPIs.every(api => typeof window[api] === 'function');
  }}
];
